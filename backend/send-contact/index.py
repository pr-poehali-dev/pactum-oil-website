'''
Business: Send contact form message to email
...
def handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    <html>
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            <h2 style="color: #FF8C00;">Новое сообщение с формы обратной связи</h2>
            <table style="border-collapse: collapse; width: 100%; max-width: 600px;">
                ...
                <tr>
                    ...
                    <td style="padding: 10px; border-bottom: 1px solid #ddd;">{phone if phone else 'Не указан'}</td>
                </tr>
                <tr>
                    <td style="padding: 10px; border-bottom: 1px solid #ddd; font-weight: bold; vertical-align: top;">Сообщение:</td>
